...
import br.com.exemplo.services.PartidaServices;
...
public class PartidaController {
	...
	//Retornara uma lisata de objetos 
	@ApiOperation(value = "Listar partida")
	@ApiResponses(value = {
	...
	@GetMapping
	public ResponseEntity<PartidaResponseDTO> listarPartida(){
		return ResponseEntity.ok().body(partidaService.listarParidas());
	}
