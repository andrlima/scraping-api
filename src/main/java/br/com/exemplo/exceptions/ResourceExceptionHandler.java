package br.com.exemplo.exceptions;
...
public class ResourceExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<StandardError> unauthotizedException(UnathorizedException e, HttpServletRequest request){
	...
	//Pegando Execuções em tempo de compilação
